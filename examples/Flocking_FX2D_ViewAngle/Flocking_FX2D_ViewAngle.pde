//Flocking 2D with custom gradient viz set up for FX2D renderer.  this example adds an angle parameter which allows agents to see only within the angle specified--
