//--Improved Perlin noise 2D example - objects navigate the noise field, you can adjust the scale, strength and multiplier values to drastically change the aesthetics. Example uses image luminance values as multiplier for noise parameters. Gradient viz setup for FX2D renderer
