//--Creating your own custom object that inherits from the creeper object
//--POLYMORPHISM--
...
public void setup() {
  ...
  for (int i = 0; i < creepCount; i++) {
    ...
    Creeper c = new MyObject(loc, vel, true, false, this); //--Use polymorphism to treat my object as if it was a creeper object--
    objSet.add(c);
  }
}
// -----------------------Draw-----------------------
public void draw() {
  ...
  for (Creeper d : objSet) {
    ...
    //d.behavior.flock2D(30.0f, 0.24f, 0.09f, 0.045f, objSet, this.drawConn);
    float change = 100;
    ...
    */
    ...
    if (createTrails) {
      if (obj instanceof Creeper) {  
        ...
        obj.viz.drawGradientTrails(obj.getTrailPoints(), 500, colorA, colorB, 255.0f, 1.0f);
      }
    }      
