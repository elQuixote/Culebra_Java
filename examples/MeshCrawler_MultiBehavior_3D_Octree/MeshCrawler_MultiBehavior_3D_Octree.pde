//--Mesh Crawling with behaviors and octree optimization--
//--show mesh by pressing 'd' key
...
public void draw() {
  ...
  for (Creeper c : this.creeperSet) {
    ...
    c.behavior.meshCrawl(this.mesh, 100, c.getLocation(), c.getSpeed(), 100, 2, triggerBabies, true, this.childSpawners, this.childSpawnType);
    ...
    if (this.sepFlag) {
      c.behavior.creeperSeparateOptimized_3D(100.0f, 0.09f, creeperSet, Data.getOctree(), Data.getTreeNodes(), this.drawConn);
    }
    if (this.cohFlag) {
