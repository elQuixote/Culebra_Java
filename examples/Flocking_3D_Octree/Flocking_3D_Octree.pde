//--Flock 3D optimized with octree from toxi--
//--viz tree by pressing 'o' key--
...
public void draw() {
  ...
  for (Creeper c : this.creeperSet) {
    ...
    c.behavior.creeperflock(80.0f, 0.24f, 0.09f, 0.045f, 0.0f, creeperSet, Data.getOctree(), Data.getTreeNodes(), this.drawConn);
