//--Improved Perlin noise 3D example - objects navigate the noise field, you can adjust the scale, strength and multiplier values to drastically change the aesthetics.
...
public void draw() {
  ...
  for (Creeper c : this.creeperSet) {
    ...
    c.behavior.perlin(500,7.0f,1.5f,1.0f);
